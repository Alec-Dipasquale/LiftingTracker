...
public class Pop extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(Integer.parseInt(reps)){
            case 1: oneRM = (int)(Integer.parseInt(weight));
                    break;
            case 2: oneRM = (int)(Integer.parseInt(weight)/.95);
                break;
            case 3: oneRM = (int)(Integer.parseInt(weight)/.93);
                break;
            case 4: oneRM = (int)(Integer.parseInt(weight)/.9);
                break;
            case 5: oneRM = (int)(Integer.parseInt(weight)/.87);
                break;
            case 6: oneRM = (int)(Integer.parseInt(weight)/.85);
                break;
            case 7: oneRM = (int)(Integer.parseInt(weight)/.83);
                break;
            case 8: oneRM = (int)(Integer.parseInt(weight)/.80);
                break;
            case 9: oneRM = (int)(Integer.parseInt(weight)/.77);
                break;
            case 10: oneRM = (int)(Integer.parseInt(weight)/.75);
                break;
            case 11: oneRM = (int)(Integer.parseInt(weight)/.73);
                break;
            case 12: oneRM = (int)(Integer.parseInt(weight)/.7);
                break;
